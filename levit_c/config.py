...
def create_parser():
    ...
    parser_config.add_argument('-c', '--config', type=str, default='/home/work/user-job-dir/V0001/configs/levit/levit_128s_ascend.yaml',
    ...
    group.add_argument('--val_while_train', type=str2bool, nargs='?', const=True, default=True,
